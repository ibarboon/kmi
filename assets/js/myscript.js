...
$(document).ready(function(){
	...
	// Main Slider
		...
		var options = {
			...
			preloader: true,
			/*preloadTheseImages: [
			    "assets/images/main_slide/home_banner1.jpg",
			    "assets/images/main_slide/home_banner2.jpg",
			    "assets/images/main_slide/home_banner3.jpg",
			    "assets/images/main_slide/home_banner4.jpg"
			],*/
	...
	// Shop Slider
		...
		var options = {
			...
			preloader: true,
			preloadTheseImages: [
			    "_/images/shop/banners/main_banner_shop_1.jpg",
			    "_/images/shop/banners/main_banner_shop_2.jpg",
			    "_/images/shop/banners/main_banner_shop_3.jpg",
			],
			reverseAnimationsWhenNavigatingBackwards : false,	
			preventDelayWhenReversingAnimations : true
		};
...
(function(iniframe){
	'use strict';
	document.writeln('<script src="assets/js/core.js"></script>');
	document.writeln('<script src="assets/js/scrollspy.js"></script>');

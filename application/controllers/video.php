...
class Video extends CI_Controller {
	...
	public function detail(){
		$params['header']['current_page'] = ($this->uri->segment(1))? $this->uri->segment(1): 'home';
		$params['footer']['current_page'] = $params['header']['current_page'];
		$this->load->view('frontend_header', $params['header']);
		$this->load->view('video_detail');
		$this->load->view('frontend_footer', $params['footer']);
	}
}
